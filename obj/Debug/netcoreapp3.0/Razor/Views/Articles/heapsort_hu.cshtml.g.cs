#pragma checksum "/Users/patrik.nusszer/nusstudios/Views/Articles/heapsort_hu.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6984b431ee1651c68e2a9c0c1abf34abe052e287"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Articles_heapsort_hu), @"mvc.1.0.view", @"/Views/Articles/heapsort_hu.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6984b431ee1651c68e2a9c0c1abf34abe052e287", @"/Views/Articles/heapsort_hu.cshtml")]
    ...
    public class Views_Articles_heapsort_hu : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <article>
        ...
        <p>
            ...
            Ha mondj");
                WriteLiteral(@"uk, n = 3 (level 4), akkor index = 2^0 + 2^1 + 2^2 = 7, mivel össze kell adjuk az 1-es, 2-es, 3-as szintek pontjainak a számát hogy megkapjuk 4-es szint első elemének indexét.<br/>
            <br/>
        ...
        <p>
            ...
            2^n = x + 1<br/>
            <br/>
            1 összegtagot mindig 1 faktorrá tudunk alakí");
                WriteLiteral(@"tani, és n darab ilyen tagunk van összesen.<br/>
            <br/>
        ...
        ");
                WriteLiteral(@"    Where x is the zero-based index of node n, such that it is also the number of nodes left to it on the same level.
            <br/>
            ...
            And you need to add 2 times x more to that, because x is the number of nodes which precede the par");
                WriteLiteral(@"ent node, and since it is a complete binary tree whose leftmost part is always complete, 2 children per every node preceding the parent precede its left immediate child.<br/>
            <br/>
        ...
        <p>
            ...
            <br/>
            The heapify functions are able to heapi");
                WriteLiteral(@"fy such a (sub)tree in which only the apex/top node is at wrong position in relation to other nodes of that (sub)tree.<br/>
            ...
            Now ");
                WriteLiteral(@"you could then heapify subtrees DEFG because subtrees HIJKLMNO are already heapified.<br/>
        ...
        <p>
            A single heapify call will restore a node and its 2 immediate children into correct relative position, meaning it will generate a correct loc");
                WriteLiteral(@"al binary heap at that aggregate of nodes.<br/>
        ...
        <p>
            ...
            First off, of course, this incorrect node is the apex of t");
                WriteLiteral(@"he subtree which we are looking at, but whenever it is bubbled down to a lower level, we get another binary heap in which all nodes except that node are in correct position relative to each other, and the bubbled down node may only be in incorrect position relative to its subordinates - so it is always in correct position relative to its superordinates inside that subtree - until that we will continue bubbling it down, until it either hits the end of the tree at which point it simply can not be any longer at incorrect position relative to subordinates, or until, the 1 subordinate is found to be in correct position relative to it, at which point all indirect subordinates must also be in correct position relative to it.
        </p>
        <p>
            1) Here, safe means on 1 hand, that bubbling up a node does not put that node into an incorrect position relative to any other (sub)tree nodes, if it was in correct position to all of them before, since its former immediate children are still subordinate t");
                WriteLiteral(@"o it, but now indirectly, and all its former indirectly superordinate nodes are still superordinate, the closest now being immediate parent to it.<br/>
        ...
        <p>
            ...
            <br/>
            1) none of the new immediate children of the bubbled down n");
                WriteLiteral(@"ode are in incorrect position relative to it, which of course also means none of its indirect children are at incorrect position relative to it<br/>
        ...
        <p>
            ...
            <br/>
            Building a minimum heap is exactly the same story, but instread you are looking for smallest element out of the 3 and b");
                WriteLiteral(@"ubble that up, while bubbling the apex down to its place.
        </p>
        <p>
            ...
            After heapification, you will have the largest node of the 1 smaller tree at the top position, but since this new tree was basically the largest plus all the rest, the largest of the r");
                WriteLiteral(@"est is going to be the second largest.<br/>
